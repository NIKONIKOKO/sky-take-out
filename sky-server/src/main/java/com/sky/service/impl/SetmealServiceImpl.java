...
public class SetmealServiceImpl implements SetmealService {
    ...
    public void updateSetmeal(SetmealDTO setmealDTO) {
        ...
        setmealDishService.deleteSetmealDishesBySetmealId(setmealDTO.getId());
        for (SetmealDish setmealDish : setmealDishList) {
    ...
    public void deleteSetmeals(String ids) {
        ...
        for(String id : idList){
            setmealMapper.deleteSetmealById(Long.valueOf(id));
            setmealDishService.deleteSetmealDishesBySetmealId(Long.valueOf(id));
        }
    }
}
